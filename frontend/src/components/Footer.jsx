...
export function Footer() {
  ...
  const link = { textDecoration: 'none', fontSize: 13, color: `rgba(${c.textRgb},0.75)` };
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ maxWidth: 320 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
            <BrandLogo src={logoSrc} height={26} glow="0 0 8px rgba(145,132,217,0.3)" />
          </div>
          <p style={{ fontSize: 13, color: `rgba(${c.textRgb},0.55)`, lineHeight: 1.6, margin: 0 }}>
      ...
      <p style={{ textAlign: 'center', fontSize: 12, color: `rgba(${c.textRgb},0.35)`, margin: '28px 0 0' }}>
